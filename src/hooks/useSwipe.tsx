...
const useSwipe = (input: SwipeInput): SwipeOutput => {
  ...
  const onTouchStart = (e: TouchEvent) => {
    ...
    touchEndX.current = 0; // otherwise the swipe is fired even with usual touch events
    touchStartX.current = e.targetTouches[0].clientX;
    touchEndY.current = 0; // otherwise the swipe is fired even with usual touch events
