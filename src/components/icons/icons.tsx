...
export const share: ReactElement = (
  <FontAwesomeIcon icon={faShare} className="xmb-icon justify-self-center" />
);
export const fontAwesome: ReactElement = (
  <FontAwesomeIcon icon={faFontAwesome} className="xmb-icon justify-self-center" />
);
export const codeFork: ReactElement = (
  <FontAwesomeIcon icon={faCodeFork} className="xmb-icon justify-self-center" />
);
...
export const statsFm: ReactElement = (
  <svg className="xmb-icon justify-self-center fill-white stroke-white" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
...
export const nextJs: ReactElement = (
  <svg className="xmb-icon justify-self-center fill-white stroke-white" viewBox="0 0 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    <g>
